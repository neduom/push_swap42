...
/*   Updated: 2025/02/03 16:30:57 by mel-moud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_three(t_stack_node **stack_a)
{
	...
	if ((*stack_a)->value == largest_node->value)
		ra(stack_a);
	else if ((*stack_a)->next->value == largest_node->value)
		rra(stack_a, false);
...
void	sort_four(t_stack_node **stack_a, t_stack_node **stack_b)
{
	...
	{
		while (smallest_node->value != (*stack_a)->value)
		{
			rra(stack_a, false);
		}
		pb(stack_b, stack_a);
